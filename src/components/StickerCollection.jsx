...
const StickerCollection = ({ collection = [], onDelete, onDownload, onClearAll }) => {
    ...
    const hasStickers = collection.some(x => x !== null);
        ...
        <div className="panel-bg p-6 mt-8">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-lg font-bold text-white">Collection (收錄區) - {collection.filter(x => x).length}/40</h2>
                </div>
